...
#define DEFINE_RCS                       \
  ...
  DEFINE_RC(SUB_QUERY_RETURNS_MULTIPLE_COLUMNS)           \
  DEFINE_RC(SUB_QUERY_RETURNS_MULTIPLE_VALUES)           \
  DEFINE_RC(PREDICATE_IS_NOT_COMPARISON)           \
  DEFINE_RC(ALIAS_NOT_EXISTS)           \
  DEFINE_RC(ASSIGNMENT_NULL_VALUE)           \
